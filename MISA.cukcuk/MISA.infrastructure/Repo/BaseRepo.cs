...
using MISA.infrastructure.Attributes;
   ...
   public class BaseRepo<MisaEntity> : IBaseRepo<MisaEntity>
    ...
    {   
        ...
        public BaseRepo(IConfiguration configuration)
        {
            ...
            _configuration = configuration.GetConnectionString("CukCukDatabase");
        ...
        public MisaEntity GetCode(string misaEntityCode)
        {
            var className = typeof(MisaEntity).Name;
            // Truy cập vào database
            // Khai báo thông tin database
